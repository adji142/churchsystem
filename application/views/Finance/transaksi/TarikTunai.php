        ...
        <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-3 col-sm-3 ">
              ...
              <input type="hidden" name="BaseType" id="BaseType" value="TT">
            </div>
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Dari Bank <span class="required">*</span>
            </label>
...
<script type="text/javascript">
  $(function () {
    ...
    $('#post_').submit(function (e) {
      ...
      $.ajax({
        type    :'post',
        url     : '<?=base_url()?>TransaksiKasController/TarikTunai',
        data    : me.serialize(),
        dataType: 'json',
