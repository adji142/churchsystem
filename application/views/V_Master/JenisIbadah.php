  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Modal Jenis Ibadah</h4>
      ...
      <div class="modal-body">
        <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Jenis Ibadah <span class="required">*</span>
            </label>
            <div class="col-md-9 col-sm-9 ">
              <input type="text" name="NamaJenisIbadah" id="NamaJenisIbadah" required="" placeholder="Jenis Ibadah" class="form-control ">
...
<script type="text/javascript">
  $(function () {
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        type: "post",
        url: "<?=base_url()?>JenisIbadahController/Read",
    ...
    $('#post_').submit(function (e) {
      ...
      $.ajax({
        type    :'post',
        url     : '<?=base_url()?>JenisIbadahController/CRUD',
        data    : me.serialize(),
        dataType: 'json',
        success : function (response) {
      ...
      $.ajax({
        ...
        success: function (response) {
          $.each(response.data,function (k,v) {
            ...
            $('#id').val(v.id);
            $('#NamaJenisIbadah').val(v.NamaJenisIbadah);
    ...
    function bindGrid(data) {
      ...
      $("#gridContainer").dxDataGrid({
        allowColumnResizing: true,
            ...
            columns: [
                {
                    dataField: "NamaJenisIbadah",
                    caption: "Jenis Ibadah",
                    allowEditing:false
                },
                {
                    dataField: "CabangID",
