        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-3 ">
                Jenis Transaksi
                <select class="form-control col-md-6" id="TipeTransaksiFilter" name="TipeTransaksiFilter" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tipe Transaksi <span class="required">*</span>
            </label>
            <div class="col-md-9 col-sm-9 ">
              <select class="form-control col-md-6" id="TipeTransaksi" name="TipeTransaksi" >
                <option value="1">Penerimaan KAS</option>
                <option value="2">Pengeluaran KAS</option>
              </select>
            </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-9 col-sm-9 ">
              <select class="form-control col-md-6" id="KodeAkunKas" name="KodeAkunKas" >
              </select>
            </div>
          </div>
    ...
    function readData() {
      $.ajax({
        ...
        data: {
          ...
          'Transaksi':$('#TipeTransaksiFilter').val(),
