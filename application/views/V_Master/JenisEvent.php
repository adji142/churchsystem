  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Modal Jenis Event</h4>
      ...
      <div class="modal-body">
        <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Jenis Event <span class="required">*</span>
            </label>
            <div class="col-md-9 col-sm-9 ">
              <input type="text" name="NamaJenisEvent" id="NamaJenisEvent" required="" placeholder="Jenis Event" class="form-control ">
...
<script type="text/javascript">
  $(function () {
    ...
    $('#post_').submit(function (e) {
      ...
      $.ajax({
        type    :'post',
        url     : '<?=base_url()?>JenisEventController/CRUD',
        data    : me.serialize(),
        dataType: 'json',
        success : function (response) {
          if(response.success == true){
      ...
      $.ajax({
        ...
        success: function (response) {
          $.each(response.data,function (k,v) {
            ...
            $('#id').val(v.id);
            $('#NamaJenisEvent').val(v.NamaJenisEvent);
