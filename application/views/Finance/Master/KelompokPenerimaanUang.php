      ...
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
          <div class="x_title">
            <!-- <h2>Akun Kas</h2> -->
            <div class="row">
              <h2>Kelompok Penerimaan Uang</h2>
            </div>
            <div class="row">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Kelompok Penerimaan Uang</h4>
      ...
      <div class="modal-body">
        <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama Penerimaan Uang <span class="required">*</span>
            </label>
            <div class="col-md-9 col-sm-9 ">
              <input type="text" name="NamaPenerimaanUang" id="NamaPenerimaanUang" required="" placeholder="Nama Penerimaan Uang" class="form-control ">
...
<script type="text/javascript">
  $(function () {
    ...
    $('#post_').submit(function (e) {
      ...
      $.ajax({
        type    :'post',
        url     : '<?=base_url()?>KelompokPenerimaanUangController/CRUD',
        data    : me.serialize(),
        dataType: 'json',
    ...
    function GetData(id,CabangID) {
      ...
      $.ajax({
        type: "post",
        url: "<?=base_url()?>KelompokPenerimaanUangController/Read",
        ...
        success: function (response) {
          $.each(response.data,function (k,v) {
            ...
            $('#id').val(v.id);
            $('#NamaPenerimaanUang').val(v.NamaPenerimaanUang);
