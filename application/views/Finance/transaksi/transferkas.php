	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
		    	<h4 class="modal-title" id="myModalLabel">Transfer Kas</h4>
		    ...
		    <div class="modal-body">
		    	<form id="post_" data-parsley-validate class="form-horizontal form-label-left">
			        ...
			        <div class="item form-group">
			            ...
			            <div class="col-md-10 col-sm-10 ">
			            	<select class="form-control" id="KodeAkunAsal" name="KodeAkunAsal" >
				            </select>
			            </div>
			        </div>
			        ...
			        <div class="item form-group">
			            ...
			            <div class="col-md-10 col-sm-10 ">
			            	<select class="form-control" id="KodeAkunTujuan" name="KodeAkunTujuan" >
				            </select>
			            </div>
			        </div>
			        ...
			        <div class="item form-group">
			            ...
			            <input type="text" name="Jumlah" id="Jumlah" required="" class="form-control " value="0">
			        </div>
			        ...
			        <div class="item form-group">
			            ...
			            <input type="text" name="Keterangan" id="Keterangan" required="" class="form-control " value="">
			        </div>
...
<script type="text/javascript">
	$(function () {
	    ...
	    function getHeader() {
	      $.ajax({
	        type: "post",
	        url: "<?=base_url()?>TransferKasController/ReadHeader",
	        data: {
	          'TglAwal':$('#TglAwal').val(),
	      ...
	      $.ajax({
	        ...
	        success: function (response) {
	          $.each(response.data,function (k,v) {
	            ...
	            $('#Jumlah').val(v.Jumlah);
	            $('#Jumlah').attr("originalvalue", v.Jumlah);
	            // $('#Jumlah').focus();
	            var textbox = $('#Jumlah')[0];
	            textbox.focus();
	    ...
	    function bindGridDetail(data) {
	    	var dataGridInstance = $("#gridContainerDetail").dxDataGrid({
	    		allowColumnResizing: true,
		        dataSource: data,
		        keyExpr: "NamaAkun",
		        showBorders: true,
