        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12" >
                <div class="item form-group">
                  <label class="col-form-label col-md-2 col-sm-2" for="first-name" style="display: none">PIC Persembahan <span class="required" >*</span>
                  </label>
...
<script type="text/javascript">
  $(function () {
    ...
    $(document).ready(function () {
      ...
      var comboCabang = document.getElementById('CabangID');
      var comboIbadah = document.getElementById('JadwalIbadahID');
      xNamaCabang = comboCabang.options[comboCabang.selectedIndex].text;
      xNamaIbadah = comboIbadah.options[comboIbadah.selectedIndex].text;

      $('#TitleText').text(xNamaCabang + " " + xNamaIbadah)
      GetPersonel();
      getAkunKas();
    ...
    function getAkunKas() {
      $.ajax({
        ...
        data: {'KodeAkun':'', 'CabangID': $('#CabangID').val(),'JadwalIbadahID': JadwalIbadahID },
        dataType: "json",
        success: function (response) {
    ...
    function CalculateTotal() {
      ...
      for (var i = 0; i < objectID.length; i++) {
        console.log($('#Tot'+objectID[i]['ID']).attr('name'))
